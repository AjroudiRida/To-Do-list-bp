...
- [Live Demo Link](https://ajroudirida.github.io/To-Do-list/dist)
...
Install this project with: git clone https://github.com/AjroudiRida/To-Do-list.git command and then use cd TO-DO-LIST command to access the local repository.

### Usage

To run the project, use the commad line "npm start" then a new tab will open in your browser with the to Do list app.
